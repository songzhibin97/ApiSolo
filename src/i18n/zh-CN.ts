export default {
  ...
  response: {
    ...
    copyFailed: "复制失败",
    downloadBody: "下载",
    bodyScopeFull: "复制与下载给出完整正文（{count} 个字符）；上面的视图可能已格式化或已截断。",
    bodyScopeReceived: "复制与下载给出已接收的正文（{count} 个字符）；其余部分从未从网络读到。",
    bodyScopeStored: "复制与下载给出 ApiSolo 手里的这份正文（{count} 个字符）。ApiSolo 无法确认它就是完整响应：只有直接从网络读到的正文才能被担保，而历史在保存时会把过长的正文截短。",
