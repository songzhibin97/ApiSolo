export default {
  ...
  response: {
    ...
    bodyCharacterCount: "{count} character | {count} characters",
    bodyScopeFull: "Copy and download give the complete body ({characters}); the view on screen may be formatted or cut short.",
